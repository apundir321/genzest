...
<c:forEach items="${courseTypes}" var="courseType" varStatus="status">
...
courseType.push('<a href="deletecourse.html?courseId=${courseType.id}"  onclick="return confirm(\'Are you sure?\')"><i class="fa fa-trash"/></a>');
dataSet.push(courseType);
</c:forEach>
	var cate = [
       [ "2", "BE/ B.Tech", "Active", "26/05/2021", "Administrator", "----" ],
    ...
    [ "3", "BBA/ B.sc", "Active", "26/05/2021", "Administrator", "----" ],
    ...
    [ "1", "BA", "Active", "26/05/2021", "Administrator", "----" ]
	...
	<div class="wrapper">
		...
		<div class="main">
            ...
            <main class="content">
               ...
               <button class="csv"><a href="course-edit-genz.html">Add  <i class="fa fa-plus" aria-hidden="true"></i></a></button>
