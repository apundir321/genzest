			...
			<main class="content">
                <div class="container-fluid1">
                   <div class="row firstrow">
                       <div class="col-lg-12">
                        <button type="submit" class="csv"><a href="course-genz.html">Back  <i class="fa fa-chevron-left" aria-hidden="true"></i></a></button>
                       </div>
                   </div>
...
<!--                             </select> -->
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 searchjobs">
                        <h4>Status </h4>
                         <form:select path="courseTypeStatus" class="form-control">
                          <form:option class="first-op" value="">Select</form:option> 
                          <form:option value="Active">Active</form:option>
                          <form:option value="In-Active">In-Active</form:option>
                        </form:select>   
                        <form:errors path="courseTypeStatus" cssClass="error"></form:errors>            
                       </div>
