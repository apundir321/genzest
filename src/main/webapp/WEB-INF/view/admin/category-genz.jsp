...
category.push('<a href="deleteCategory.html?categoryId=${category.id}"  onclick="return confirm(\'Are you sure?\')"><i class="fa fa-trash"/></a>');
dataSet.push(category);
</c:forEach>


	var cate = [
       [ "2", "Customer Service", "Active", "26/05/2021", "Administrator", "----" ],
    ...
    [ "3", "Finance", "Active", "26/05/2021", "Administrator", "----" ],
    ...
    [ "1", "Sales", "Active", "26/05/2021", "Administrator", "----" ]
	...
	<div class="wrapper">
		...
		<div class="main">
            ...
            <main class="content">
               ...
               <button class="csv"><a href="category-edit-genz.html">Add  <i class="fa fa-plus" aria-hidden="true"></i></a></button>
