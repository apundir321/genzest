...
<head>
	...
	<link href="assets-3/css/app.css" rel="stylesheet">

	<link href="assets-3/css/style.css" rel="stylesheet">
	<link href="assets-3/css/style2.css" rel="stylesheet">
	<link href="assets-3/css/style3.css" rel="stylesheet">
	<link href="assets-3/css/style4.css" rel="stylesheet">
...
<script>
    ...
    [ "1", "A11223", "Techworld", "HR", "xyz@gmail.com", "9087654321", "Gurgaon", "Done", "26/05/2021", "---" ]
...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a href="index.html"><img src="assets-3/img/icons/Genzest Logo.png" alt="" class="img-responsive logo"></a></a>
				...
				<br>
					...
					<a class="sidebar-link" href="emloyer.html"><i class="fa fa-user-o align-middle" style="font-size:19px"></i> <span class="align-middle"><b>Employer</b></span>
					</a></li>

					<li class="sidebar-item">
					<a class="sidebar-link" href="candidate.html"><i class="fa fa-search align-middle" style="font-size:19px"></i> <span class="align-middle"><b>Search Student</b></span>
					</a></li>
		...
		<div class="main">
			...
			<nav class="navbar navbar-expand">
				<a class="sidebar-toggle js-sidebar-toggle">
					<img src="assets-3/img/icons/Shape@1X (3).png">
               </a>
			   <h4><b>Employer</b></h4>
			...
			<main class="content">
				...
				<button class="csv"><a href="">Download CSV</a></button>
	...
	<script src="assets-3/js/app.js"></script>
