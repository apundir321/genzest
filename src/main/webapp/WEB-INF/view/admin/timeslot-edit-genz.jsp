			...
			<main class="content">
                <div class="container-fluid1">
                   <div class="row firstrow">
                       <div class="col-lg-12">
                        <button type="submit" class="csv"><a href="timeslot-genz.html">Back  <i class="fa fa-chevron-left" aria-hidden="true"></i></a></button>
                       </div>
                   </div>
                  <form:form action="/timeslot-edit-genz.html" method="post" modelAttribute="timeSlot">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 searchjobs">
                       ...
                       <form:select class="form-control" path="timeSlotStatus">
                          <form:option class="first-op" value="">Select</form:option> 
                          <form:option value="Active"></form:option>
                          <form:option value="In-Active"></form:option>
                        </form:select>
                         <form:errors path="timeSlotStatus" cssClass="error"></form:errors>
                      </div>
