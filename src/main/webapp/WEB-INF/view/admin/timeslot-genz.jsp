...
timeSlot = new Array();
timeSlot.push('${timeSlot.id}');
timeSlot.push('${timeSlot.timeSlotName}');
...
timeSlot.push('<a href="deletetimeslot.html?timeSlotId=${timeSlot.id}"  onclick="return confirm(\'Are you sure?\')"><i class="fa fa-trash"/></a>');
dataSet.push(timeSlot);
</c:forEach>
	var dataSet2 = [
       [ "2", "12pm - 4pm", "Active", "26/05/2021", "Administrator", "----" ],
    ...
    [ "3", "4pm - 6pm", "Active", "26/05/2021", "Administrator", "----" ],
    ...
    [ "1", "8am - 12pm", "Active", "26/05/2021", "Administrator", "----" ]
	...
	<div class="wrapper">
		...
		<div class="main">
            ...
            <main class="content">
               ...
               <button class="csv"><a href="timeslot-edit-genz.html">Add  <i class="fa fa-plus" aria-hidden="true"></i></a></button>
