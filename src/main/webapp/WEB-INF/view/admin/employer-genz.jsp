...
employer = new Array();
employer.push('${employer.clientCode}');
...
employer.push('<a href="editEmployer.html?employerId=${employer.id}"><i class="fa fa-pencil"/></a>');
		...
		<div class="main">
            ...
            <main class="content">
               ...
               <!-- <div class="row2">
                ...
                <button class="csv"><a href="/emp-edit-genz.html">Add  <i class="fa fa-plus" aria-hidden="true"></i></a></button>
