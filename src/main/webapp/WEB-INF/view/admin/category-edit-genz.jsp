			...
			<main class="content">
                <div class="container-fluid1">
                   <div class="row firstrow">
                       <div class="col-lg-12">
                        <button type="submit" class="csv"><a href="category-genz.html">Back  <i class="fa fa-chevron-left" aria-hidden="true"></i></a></button>
                       </div>
                   </div>
                   <form:form action="/category-edit-genz.html" method="post" modelAttribute="category">
                    <div class="form-row">
                    ...
                    <form:input path="id" placeholder="First Name"
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 searchjobs">
                        ...
                        <form:errors path="categoryStatus" cssClass="error"></form:errors>
                      </div>
                      
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 searchjobs">
                        <h4>Category code <span>*</span></h4>
                         <form:input class="form-control" path="categoryCode"
								placeholder="Category code" id="example-tel-input" />
                        <form:errors path="categoryCode" cssClass="error"></form:errors>
                      </div>
