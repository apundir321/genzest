...
dataSet.push(courseType);
    ...
    [ "001", "Ritik","200", "60 Hrs", "20,000", "20,000", "<a style='color:white'; href=''>Raise a query</a>" ]
...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a href="student-d.html"><img src="assets-2/img/icons/Genzest Logo.png" alt="" class="img-responsive logo"></a></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form:form action="raiseQuery.html" method="post" modelAttribute="raiseQuery">
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <form:input type="text" class="form-control" id="jobId"  path="jobId"/>
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Message:</label>
            <form:textarea class="form-control" id="message-text" path="message"/>
          </div>
