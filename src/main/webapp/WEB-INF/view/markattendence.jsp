...
<body>
	<div class="wrapper">
		...
		<div class="main">
          ...
          <!-- Login Form -->
         <form:form action="/markAttendencePost.html"  method='POST' id="loginForm">
         					<input type="hidden" class="form-control" value="${applicationId}" id="applicationId" name="applicationId" />
         
							<div class="form-group">
								<label class="col-sm-3 control-label" for="username">Checkin time</label>
								<div class="col-sm-9">
									<input type="time" class="form-control" id="checkinTime" name="checkinTime" placeholder="Check in Time" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label" for="username">Checkout time</label>
								<div class="col-sm-9">
									<input type="time" class="form-control" id="checkoutTime" name="checkoutTime" placeholder="Check out Time" />
								</div>
							</div>
