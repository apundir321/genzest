		...
		<div class="main">
         ...
         <form:form action="/markAttendencePost.html" modelAttribute="markAttendence"  method='POST' id="loginForm">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input type="time" class="form-control" path="checkinTime" id="checkinTime" name="checkinTime" placeholder="Check in Time" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input type="time" class="form-control" path="checkoutTime" id="checkoutTime" name="checkoutTime" placeholder="Check out Time" />
								</div>
							</div>
