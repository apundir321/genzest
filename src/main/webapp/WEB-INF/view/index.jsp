		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<br>
					...
					<a class="sidebar-link" href="pages-profile.html"><i class="fa fa-rocket align-middle" style="font-size:21px"></i> <span class="align-middle"><b>About Us</b></span>
                    </a></li>

					<li class="sidebar-item">
					<a class="sidebar-link" href="pages-sign-in.html"><i class='fa fa-archive align-middle' style='font-size:19px'></i> <span class="align-middle"><b>Business</b></span>
                    </a></li>

					<li class="sidebar-item">
					<a class="sidebar-link" href="pages-sign-up.html"><i class='fa fa-envelope-o align-middle' style='font-size:19px'></i> <span class="align-middle"><b>Contact Us</b></span>
                    </a></li>
