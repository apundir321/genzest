...
jobArray.push('------');
jobArray.push('<a href="updatejobs-recruiter.html?jobId=${job.id}"><i class="fa fa-pencil"/></a>');
	...
	<div class="wrapper">
		...
		<div class="main">
            ...
            <main class="content">
               ...
               <button class="csv"><a href="editjobs-recruiter.html">Add  <i class="fa fa-plus" aria-hidden="true"></i></a></button>
